...
# TODO - добавить кнопку под ответам с вакансия "Добавить в зкладки" при добавлении сменить кнопку на "В закладке"
...
# При клике на запрос появляеются резутаты запроса